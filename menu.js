        ...
        a.addEventListener('click', () => {
            ...
            document.getElementById('offcan').innerHTML += `
                <div class="card" style="width: 250px;" data-price="150">
        ...
        b.addEventListener('click', () => {
            ...
            document.getElementById('span').innerText = d;
            document.getElementById('offcan').innerHTML += `
                <div class="card" style="width: 250px;" data-price="180">
        ...
        c.addEventListener('click', () => {
            ...
            document.getElementById('span').innerText = d;
            document.getElementById('offcan').innerHTML += `
                <div class="card" style="width: 250px;" data-price="70">
        ...
        e.addEventListener('click', () => {
            ...
            document.getElementById('span').innerText = d;
            document.getElementById('offcan').innerHTML += `
                <div class="card" style="width: 250px;" data-price="250">
        ...
        f.addEventListener('click', () => {
            ...
            document.getElementById('span').innerText = d;
            document.getElementById('offcan').innerHTML += `
                <div class="card" style="width: 250px;" data-price="100">
        ...
        g.addEventListener('click', () => {
            ...
            document.getElementById('span').innerText = d;
            document.getElementById('offcan').innerHTML += `
                <div class="card" style="width: 250px;" data-price="200">
        ...
        h.addEventListener('click', () => {
            ...
            document.getElementById('span').innerText = d;
            document.getElementById('offcan').innerHTML += `
                <div class="card" style="width: 250px;" data-price="120">
        ...
        i.addEventListener('click', () => {
            ...
            document.getElementById('span').innerText = d;
            document.getElementById('offcan').innerHTML += `
                <div class="card" style="width: 250px;" data-price="110">
        ...
        j.addEventListener('click', () => {
            ...
            document.getElementById('span').innerText = d;
            document.getElementById('offcan').innerHTML += `
                <div class="card" style="width: 250px;" data-price="160">
